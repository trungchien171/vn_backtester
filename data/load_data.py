...
datafields = {
        ...
        'USDPairs': {
            'close': 'data/forex/price_volume/close_matrix_usdpairs.txt',
            'open': 'data/forex/price_volume/open_matrix_usdpairs.txt',
            'high': 'data/forex/price_volume/high_matrix_usdpairs.txt',
            'low': 'data/forex/price_volume/low_matrix_usdpairs.txt',
            'volume': 'data/forex/price_volume/volume_matrix_usdpairs.txt',
            'vwap': 'data/forex/price_volume/vwap_matrix_usdpairs.txt',
            'adv20': 'data/forex/price_volume/adv20_matrix_usdpairs.txt',
            'adv60': 'data/forex/price_volume/adv60_matrix_usdpairs.txt',
            'adv120': 'data/forex/price_volume/adv120_matrix_usdpairs.txt',
            'daily_return': 'data/forex/price_volume/daily_return_matrix_usdpairs.txt',
    }
}
